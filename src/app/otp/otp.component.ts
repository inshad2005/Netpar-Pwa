  ...
  onValidateOtp(){
      if(this.otp == this.appProvider.current.otp){
          ...
          if (this.appProvider.current.toOtpPageFlag=="SingIn") {
            ...
            localStorage['state']=this.appProvider.current.userData.state;
            localStorage['district']=this.appProvider.current.userData.district;
            localStorage['dateOfBirth']=this.appProvider.current.userData.dateOfBirth
            localStorage['gender']=this.appProvider.current.userData.gender;
            localStorage['block']=this.appProvider.current.userData.block;
