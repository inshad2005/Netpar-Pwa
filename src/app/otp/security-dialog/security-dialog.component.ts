...
export class SecurityDialogComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,private appProvider:AppProvider,private dialog: MdDialog,private securityDialogService:SecurityDialogService ,public dialogRef: MdDialogRef<SecurityDialogComponent>,private stateService:StateService,
