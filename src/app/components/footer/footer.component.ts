...
export class FooterComponent implements OnInit {
  ...
  constructor(private analyticsService:AnalyticsService,private domSanitizer:DomSanitizer,private appProvider:AppProvider,private router:Router,private fb: FacebookService) {
