...
export class AllPostsService {
  ...
  constructor(private http:Http) { }
    ...
    editSubCategoriesPageView(userId,subCategoryId):Observable<any>{
        let api = environment.endPoint+"editCategoryPageView/"+subCategoryId
        let body = {
            user_id:userId
        }
        return this.http.post(api,body)
    ...
    editCategoryTotalTime(categoryId,time){
    ...
    editSectionTotalTime(sectionId,time){
    ...
    editSubCategoriesTotalTime(subcategoryId,time){
